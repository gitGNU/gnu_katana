...
PATCHER_SRC=src/patcher/hotpatch.c src/patcher/target.c src/patcher/patchapply.c src/patcher/versioning.c src/patcher/linkmap.c src/patcher/safety.c src/patcher/pmap.c
