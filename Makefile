...
PATCHWRITE_SRC=src/patchwrite/patchwrite.c src/patchwrite/codediff.c src/patchwrite/typediff.c
...
TYPEPATCH_SRC=src/katana.c src/dwarftypes.c   src/elfparse.c  src/types.c  src/dwarf_instr.c src/register.c src/relocation.c src/symbol.c src/fderead.c src/dwarfvm.c $(PATCHWRITE_SRC) $(PATCHER_SRC) $(UTIL_SRC) $(INFO_SRC)
